...
from sklearn.model_selection import train_test_split # type: ignore z
    ...
    def build(self, hp):
        with strategy.scope():
            ...
            model.add(Dense(units=hp.Int('units1', min_value=16, max_value=128, step=4),
                            activation='relu',
                            kernel_regularizer=tf.keras.regularizers.l1_l2(l1=hp.Float('l1_1', 1e-5, 1e-1, sampling='LOG'), # type: ignore
